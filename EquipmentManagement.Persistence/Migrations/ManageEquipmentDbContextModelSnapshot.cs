...
namespace EquipmentManagement.Persistence.Migrations
{
    ...
    partial class ManageEquipmentDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Warning", b =>
                {
            ...
            modelBuilder.Entity("EquipmentProject", b =>
                {
                    b.Property<string>("EquipmentsEquipmentId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("EquipmentsEquipmentId", "ProjectName");

                    b.HasIndex("ProjectName");

                    b.ToTable("EquipmentProject");
                });
            ...
            modelBuilder.Entity("EquipmentProject", b =>
                {
                    ...
                    b.HasOne("EquipmentManagement.Domain.Project", null)
                        .WithMany()
                        .HasForeignKey("ProjectName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
